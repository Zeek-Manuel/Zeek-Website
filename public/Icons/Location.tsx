...
function Location({height, width, fill}: IconAttributes<string, number>): JSX.Element {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" width={RemCalculator<string, number>(width)} height={RemCalculator<string, number>(height)} fill={fill}>
